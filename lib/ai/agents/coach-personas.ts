...
export const AGENT_PERSONAS: Record<string, CoachPersona> = {
  ...
  automatisations: { name: "Agent process", emoji: "👨‍🔧", role: "Ingénieur workflows", pitch: "Je repère les tâches manuelles et répétitives à automatiser pour faire gagner des heures à ton équipe, sans rien casser.", gradient: "from-indigo-50 via-white to-white", tint: "text-indigo-200" },
