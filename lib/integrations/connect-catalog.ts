...
export const CONNECTABLE_TOOLS: Record<string, ConnectableTool> = {
  ...
  qonto: {
    ...
    domain: "qonto.com",
    category: "billing",
    description: "Banque pro FR. Synchronisez vos transactions bancaires (encaissements et décaissements) pour la trésorerie et la réconciliation.",
    helpUrl: "https://api-doc.qonto.com/docs/business-api/5b56d940ce478-getting-started-with-your-business-api",
    helpText: "Récupérez votre clé API : app Qonto → Paramètres → API & intégrations → Clé API. Le slug d'organisation est affiché au même endroit (ex : mon-entreprise-1234).",
    fields: [
      { key: "organization_slug", label: "Slug d'organisation", placeholder: "mon-entreprise-1234", type: "text", helper: "Identifiant affiché dans Paramètres → API & intégrations" },
      { key: "secret_key", label: "Clé secrète (API Key)", placeholder: "•••••••••••", type: "password" },
    ],
  },
  sage: {
    key: "sage",
