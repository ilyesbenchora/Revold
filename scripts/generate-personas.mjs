...
const PERSONAS = [
  ...
  { key: "coaching-data", desc: "Sofia, a female data and integration coach, dark hair in a ponytail, modern glasses, wearing a green tech shirt" },
  ...
  { key: "automatisations", desc: "Théo, a male process and tools alignment engineer, short hair, wearing a technical work shirt" },
