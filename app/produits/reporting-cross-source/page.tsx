...
export const metadata: Metadata = {
  title: "Reporting cross-source CRM × facturation",
  description: "Des KPIs câblés et vérifiés qui croisent CRM, facturation et banque : chaque chiffre affiche sa source et sa valeur calculée sur vos données réelles.",
};
