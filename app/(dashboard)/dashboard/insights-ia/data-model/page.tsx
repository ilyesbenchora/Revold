...
export default async function DataModelCoachingPage() {
  ...
  const manualCoachings = await fetchReportCoachings(supabase, orgId, "data-model", ["active", "done", "removed"]);
  ...
  return (
    <div className="space-y-6">
      ...
      <CoachActionsSection items={items} categoryLabel="finance" category="data-model" />
    </div>
  );
}
