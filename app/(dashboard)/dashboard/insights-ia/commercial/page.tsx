...
export default async function CommercialCoachingPage() {
  ...
  const manualCoachings = await fetchReportCoachings(supabase, orgId, "commercial", ["active", "done", "removed"]);
  ...
  return (
    <div className="space-y-6">
      <CoachingAgendaSection category="commercial" />
      <CoachActionsSection items={items} categoryLabel="ventes" category="commercial" />
    </div>
  );
}
