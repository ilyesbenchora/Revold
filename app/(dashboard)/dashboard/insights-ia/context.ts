...
export function buildScenarios(ctx: InsightContext) {
  ...
  // ════════════════════════════════════════════════════════════════
  // MARKETING CYCLE (15 simulations SMART)
  // ════════════════════════════════════════════════════════════════
  const lifecycle: Sim[] = [
    {
      show: true,
      title: `Conversion Lead → Opp : ${conversionRate}% → ${conversionTarget}% en 60 jours`,
      description: `${opps} opportunités sur ${tContacts.toLocaleString("fr-FR")} contacts. Top quartile B2B : ${conversionTarget}%. Lead scoring + handoff automatique = +${conversionTarget - conversionRate} pts.`,
    ...
    {
      show: true,
      title: `Lifecycle stages : 0/6 → 6/6 activés en 14 jours`,
      description: "Subscriber → Lead → MQL → SQL → Opportunity → Customer. Sans lifecycle stages, aucun funnel marketing mesurable.",
    ...
    {
      show: true,
      title: `Conversion Lead → MQL : top quartile 15% en 60 jours`,
      description: "Lead scoring sur engagement (visites, opens, downloads) + workflow auto qui passe en MQL au seuil. Cible : 10-20% de conversion Lead→MQL.",
      impact: "Pipeline marketing prédictible + handoff auto vers SDR",
      category: "marketing",
      simulationCategory: "marketing_cycle",
      color: "from-amber-500 to-orange-600",
      forecastType: "lead_to_mql",
      threshold: 15,
      direction: "above",
    },
    {
      show: true,
      title: `Conversion MQL → SQL : 25% en 60 jours (SLA 5min)`,
      description: "SLA : tout MQL contacté < 5 minutes par SDR. Workflow attribution auto round-robin. Critère SQL clair (BANT).",
      impact: "+25% de leads convertis en opportunités sales",
      category: "marketing",
      simulationCategory: "marketing_cycle",
      color: "from-yellow-500 to-amber-600",
      forecastType: "mql_to_sql",
      threshold: 25,
      direction: "above",
    },
    {
      show: true,
      title: `Conversion SQL → Opportunity : 70% en 30 jours`,
      description: "Discovery rapide post-handoff : 1er meeting < 7j, taux RDV honorés > 80%, taux création deal post-meeting > 70%.",
      impact: "Pipeline qualifié alimenté en continu",
      category: "marketing",
      simulationCategory: "marketing_cycle",
      color: "from-orange-500 to-amber-600",
      forecastType: "sql_to_opp",
      threshold: 70,
      direction: "above",
    },
    {
      show: true,
      title: `Nurturing TOFU/MOFU/BOFU : 0/3 → 3/3 en 30 jours`,
      description: "3 séquences nurturing (top/middle/bottom of funnel). 80% des leads non-immédiats convertissent à 12 mois s'ils sont nurturés.",
    ...
    },
    {
      ...
      description: "8 forms par persona × intent : démo, fiche commerciale, guide TOFU, webinar, newsletter, contact, partenaires, careers.",
    ...
    {
      show: true,
      title: `Listes segmentation : ${ctx.listsCount ?? 0} → 15 dynamiques en 30 jours`,
      description: "15 listes intelligentes (lifecycle, persona, intent, engagement). Personnalisation campagnes = +60% engagement.",
      impact: "Campagnes ciblables sur 100% de la base",
      category: "marketing",
      simulationCategory: "marketing_cycle",
    ...
    {
      show: true,
      title: `Marketing campaigns trackées : ${ctx.marketingCampaignsCount ?? 0} → 10 en 90 jours`,
      description: "Tagger TOUTES les actions marketing comme Campaigns HubSpot. Reporting mensuel revenue par campagne.",
      impact: "ROI marketing par initiative mesurable",
      category: "marketing",
      simulationCategory: "marketing_cycle",
      color: "from-amber-500 to-fuchsia-500",
    ...
    {
      show: true,
      title: `Marketing events : ${ctx.marketingEventsCount ?? 0} → 3/an (webinars, conférences)`,
      description: "Webinars, conférences, salons trackés via HubSpot Events. Connecter Zoom/On24/Eventbrite = attribution event-driven.",
    ...
    {
      show: true,
      title: `Réactivation dormants : ~${Math.round(tContacts * 0.05).toLocaleString("fr-FR")} contacts en 60 jours`,
      description: `${(tContacts - opps).toLocaleString("fr-FR")} contacts non-opp. Stat : 5% sont réactivables avec une bonne campagne (offre + content + scoring).`,
    ...
    {
      show: true,
      title: `Lead scoring composite : 0 → 1 modèle déployé en 14 jours`,
      description: "Modèle scoring : engagement (visites, opens) + firmographic (taille, secteur ICP). Workflow auto pour passage en MQL au seuil.",
      impact: "2-3x plus de meetings bookés sur le même volume de leads",
      category: "marketing",
      simulationCategory: "marketing_cycle",
      color: "from-amber-500 to-yellow-600",
      forecastType: "lead_scoring_setup",
      threshold: 1,
      direction: "above",
    },
    {
      show: true,
      title: `Lead source attribution : 100% nouveaux contacts en 30 jours`,
      description: "Workflow obligeant un Original Source à la création. Fallback heuristique sur referrer/UTM si vide. Reporting ROI par canal.",
      impact: "Attribution marketing fiable par canal d'acquisition",
      category: "marketing",
      simulationCategory: "marketing_cycle",
      color: "from-orange-500 to-amber-600",
    ...
    {
      show: true,
      title: `Programme référencement : 5% leads issus de réf en 90 jours`,
      description: "Demande systématique post-onboarding success. Réf = 3-5x meilleur win rate que cold outreach.",
    ...
    {
      show: true,
      title: `Email validation : 100% nouveaux leads validés en 7 jours`,
      description: "Brancher service email verification (NeverBounce, ZeroBounce) sur tous les nouveaux leads. Délivrabilité protégée.",
      impact: "Sender reputation maintenue + 0 bounce sur campagnes",
      category: "marketing",
      simulationCategory: "marketing_cycle",
      color: "from-amber-500 to-orange-500",
  ...
  // ════════════════════════════════════════════════════════════════
  // DEALS À RISQUES (15 simulations SMART)
  // ════════════════════════════════════════════════════════════════
  const dealsRisk: Sim[] = [
    {
      show: true,
      title: `Stagnation : ${stagnantDeals} → 0 deals figés en 14 jours`,
      description: `${stagnantDeals} deals sans activité depuis 7j+ et sans next_activity. War room hebdo : 1 décision/deal en 5min (relance OU lost).`,
      impact: `~+${Math.max(1, Math.round(stagnantDeals * 0.3))} deals récupérés, pipeline assaini`,
      category: "sales",
      simulationCategory: "deals_risk",
    ...
    {
      show: true,
      title: `Deals à risque : probabilité <30% → 0 sans plan en 14 jours`,
      description: "Tous les deals avec hs_deal_stage_probability < 0.30 doivent avoir un plan d'action explicite (note + next_activity sous 48h).",
      impact: "Pipeline réaliste, focus sur deals fermables",
      category: "sales",
      simulationCategory: "deals_risk",
      color: "from-rose-500 to-orange-600",
      forecastType: "low_probability_plan",
      threshold: 0,
      direction: "below",
    },
    {
      show: true,
      title: `Deals sans last_contact >14j : 0 en 7 jours`,
      description: "Workflow d'alerte automatique sur deal ouvert sans notes_last_contacted >14j. Tâche de relance créée pour l'owner.",
      impact: "Engagement client maintenu sur 100% des deals actifs",
      category: "sales",
      simulationCategory: "deals_risk",
      color: "from-rose-500 to-amber-600",
      forecastType: "no_recent_contact",
      threshold: 0,
      direction: "below",
    },
    {
      show: true,
      title: `Deals sans next activity : ${dealsNoNextActivity} → 0 en 7 jours`,
      description: "Workflow bloquant la sauvegarde sans next_activity_date sur deals ouverts. Effet immédiat sur la discipline pipeline.",
      impact: `${dealsNoNextActivity} deals remis en suivi proactif`,
      category: "sales",
      simulationCategory: "deals_risk",
    ...
    {
      show: true,
      title: `Win-back lost deals : 5% récupérés en 60 jours`,
      description: "Campagne dédiée sur les deals perdus depuis 6-12 mois. Stat : 5-10% de récupération possible avec une nouvelle approche.",
      impact: `~+${Math.max(1, Math.round(lost * 0.05))} deals récupérés (lost reactivation)`,
      category: "sales",
      simulationCategory: "deals_risk",
      color: "from-orange-500 to-rose-600",
      forecastType: "winback",
      threshold: Math.max(1, Math.round(lost * 0.05)),
      direction: "above",
    },
    {
      show: true,
      title: `Renouvellement : alerte J-90 sur 100% subscriptions en 14 jours`,
      description: `${ctx.subscriptionsCount ?? 0} subscriptions actives. Workflow d'alerte CSM 90j avant échéance = +5-10 pts de retention.`,
      impact: `Retention améliorée sur ${ctx.subscriptionsCount ?? 0} comptes récurrents`,
      category: "csm",
      simulationCategory: "deals_risk",
    ...
    },
    {
      ...
      description: "Score combinant : last_contacted, next_activity, probability, days_in_stage, sentiment. Notification CSM/Sales si score rouge.",
    ...
    {
      show: true,
      title: `Lost rate : ${closedTotal > 0 ? PCT(lost, closedTotal) : 0}% → ${Math.max(40, closedTotal > 0 ? PCT(lost, closedTotal) - 15 : 40)}% en 90 jours`,
      description: `${lost} perdus / ${closedTotal} clôturés. Disqualifier 30% des deals dès Discovery via ICP strict = baisse mécanique du lost rate.`,
      impact: `~+${Math.max(1, Math.round((lost - won) * 0.2))} deals win supplémentaires`,
      category: "sales",
      simulationCategory: "deals_risk",
      color: "from-orange-500 to-rose-600",
      forecastType: "lost_rate",
      threshold: Math.max(40, closedTotal > 0 ? PCT(lost, closedTotal) - 15 : 40),
      direction: "below",
    },
    {
      show: true,
      title: `Escalade manager : 100% deals Tier 1 stagnants 7j+ en 14 jours`,
      description: "Workflow auto qui notifie le manager si deal > 50k€ stagne 7j+ sans next_activity. Action requise sous 48h.",
    ...
    {
      show: true,
      title: `Deals sans owner : 0 en 30 jours (workflow attribution auto)`,
      description: "Workflow round-robin par segment à la création deal. Audit hebdo via report dédié sur deals sans hubspot_owner_id.",
      impact: "0 deal orphelin = 0 deal perdu par défaut d'attribution",
      category: "sales",
      simulationCategory: "deals_risk",
      color: "from-rose-500 to-orange-600",
      forecastType: "no_owner_clear",
      threshold: 0,
      direction: "below",
    },
    {
      show: true,
      title: `Comptes Tier 1 sans contact 30j+ : 0 en 14 jours (CSM action)`,
      description: "Top 10 comptes par MRR/ARR doivent être touchés tous les 30 jours. Workflow d'alerte si dernière activité > 30j.",
      impact: "Réduction churn Tier 1 (où le revenue est concentré)",
      category: "csm",
      simulationCategory: "deals_risk",
      color: "from-rose-500 to-pink-600",
      forecastType: "tier1_no_contact",
      threshold: 0,
      direction: "below",
    },
    {
      ...
      description: "Liste deals sans activité > 30j. Sprint dédié : pour chacun, soit relance avec plan clair, soit clôture lost avec lost_reason.",
    ...
    {
      show: true,
      title: `Audit close_date reportée 3+ fois : 0 deals 'fantômes' en 14 jours`,
      description: "Deals dont la close_date a été reportée 3+ fois = signal fort de deal mort. Décision : closer en lost ou réplanifier sérieusement.",
      impact: "Forecast nettoyé des deals fantômes",
      category: "sales",
      simulationCategory: "deals_risk",
      color: "from-rose-500 to-orange-600",
    ...
    {
      show: true,
      title: `Tickets Tier 1 ouverts >7j : 0 en 14 jours`,
      description: `${ctx.ticketsCount ?? 0} tickets ouverts. Aucun ticket sur compte Tier 1 ne doit rester ouvert > 7j sans escalade. Workflow d'alerte CSM.`,
      impact: "Risque churn anticipé sur les top customers",
      category: "csm",
      simulationCategory: "deals_risk",
      color: "from-rose-500 to-pink-600",
      forecastType: "tier1_old_tickets",
      threshold: 0,
      direction: "below",
    },
    {
      show: true,
      title: `Feedback CSAT/NPS : ${ctx.feedbackCount ?? 0} → ${Math.max(10, Math.round((ctx.ticketsCount ?? 0) * 0.3))} feedbacks/mois`,
      description: "Survey post-ticket auto + NPS trimestriel. Détracteurs flaggés comme risque churn dans HubSpot.",
      impact: "Détection proactive du churn avant qu'il soit acté",
      category: "csm",
      simulationCategory: "deals_risk",
      color: "from-rose-500 to-fuchsia-600",
  ...
  return [...cycleVentes, ...lifecycle, ...dealsRisk, ...revenue, ...dataQuality].filter((s) => s.show);
}
...
export const SIMULATION_CATEGORY_LABELS: Record<SimulationCategory, { label: string; emoji: string }> = {
  ...
  deals_risk: { label: "Deals à risques", emoji: "⚠️" },
