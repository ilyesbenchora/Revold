...
export default async function IntegrationCoachingPage() {
  ...
  const manualCoachings = await fetchReportCoachings(supabase, orgId, "integration", ["active", "done", "removed"]);
  ...
  return (
    <div className="space-y-6">
      ...
      <CoachActionsSection items={items} categoryLabel="intégration" category="integration" />
    </div>
  );
}
