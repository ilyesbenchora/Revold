...
export default async function DashboardOverviewPage() {
  ...
  const sections = [
    ...
    },
    {
      ...
      description: "Identifiants, effectifs, CA et secteur complétés via les registres officiels — jusque dans votre CRM — et hiérarchie des comptes.",
      href: "/dashboard/enrichissement",
      cta: "Ouvrir l'enrichissement",
