...
export default async function AdoptionOverviewPage() {
  ...
  const cards = [
    { href: "/dashboard/conduite-changement/activites", label: "Activités", description: "Appels, emails, RDV, notes et tâches par équipe et par utilisateur", stat: `${totalActivities.toLocaleString("fr-FR")} activités`, color: "text-emerald-500",
    ...
    { href: "/dashboard/conduite-changement/connexions", label: "Connexions", description: "Records sans activité récente, contacts et deals à relancer", stat: `${activeUsers} actifs / ${owners.length}`, color: "text-orange-500",
