...
import { boardTemplateGallery } from "@/lib/boards/board-templates";

/**
 * Templates — page À PART (sidebar Dashboard), hors des onglets Tableaux de
 * bord : la galerie des compositions prêtes à l'emploi avec APERÇU visuel de
 * chaque tableau (mini-dashboard : tuiles + graphiques), activées selon les
 * outils réellement connectés + le compositeur agent — décris ton besoin,
...
export default async function TemplatesPage() {
  ...
  const gallery = await boardTemplateGallery(supabase, orgId);
  ...
  return (
    <section className="space-y-6">
      ...
      {/* ── Galerie : toutes les compositions avec leur aperçu, disponibles ou à débloquer. ── */}
