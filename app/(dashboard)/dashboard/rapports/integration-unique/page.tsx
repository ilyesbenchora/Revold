    ...
    <section className="space-y-8">
      <header>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Rapports tirés directement d&apos;un seul outil métier connecté. Plus vos sources
          sont riches, plus l&apos;analyse devient pertinente.
        </p>
      </header>

      <RapportsTabs myCount={0} singleCount={totalReports} multiCount={multiCount} />
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
        ...
        <article className="card p-5 text-center">
          ...
          <p className="mt-1 text-xs text-slate-400">Tirés d&apos;un seul outil</p>
        </article>
        <article className="card p-5 text-center">
