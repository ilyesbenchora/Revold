...
export default function AccelererCyclesVentePage() {
  return (
    <SolutionPage
      ...
      subtitle="61% des deals perdus le sont par indécision. Revold détecte les deals silencieux sur vos données réelles et crée l'action dans le CRM — après votre validation — avant qu'il ne soit trop tard."
      ...
      shot={<ShotPipeline />}
      keyBenefits={[
        { title: "Deals silencieux détectés tôt", desc: "Inactivité prolongée détectée en déterministe sur vos données CRM — le signal remonte avant que le deal ne meure." },
        { title: "Action dans votre CRM", desc: "Deal silencieux → tâche CRM créée pour le bon owner, avec le contexte. Vous validez, Revold exécute." },
