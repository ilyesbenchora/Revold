  ...
  return (
    <SolutionPage
      ...
      teams={[
        ...
        { team: "CSM", icon: teamIcon("M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78L12 21.23l8.84-8.84a5.5 5.5 0 0 0 0-7.78z"), pain: "Pas de métriques sur la satisfaction et la rétention post-vente.", solution: "Tickets, activité CRM et paiements croisés, avec un coach service client dédié.", result: "Performance CSM mesurable. Corrélation satisfaction ↔ rétention visible." },
