  ...
  return (
    <SolutionPage
      ...
      keyBenefits={[
        ...
        { title: "Impayé → rappel officiel de facturation", desc: "~10% des churns SaaS sont involontaires : un paiement échoue et personne ne relance. Revold propose le rappel officiel de facturation, vous validez, le cash récupéré est attribué en euros." },
      ...
      teams={[
        { team: "Sales", icon: teamIcon("M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"), pain: "Les commerciaux ne savent pas quels clients sont à risque de churn.", solution: "Alerte automatique quand un client actif montre des signaux de désengagement.", result: "Le compte à risque arrive avec ses signaux chiffrés : tickets, paiements, activité CRM." },
        { team: "CSM", icon: teamIcon("M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78L12 21.23l8.84-8.84a5.5 5.5 0 0 0 0-7.78z"), pain: "Pas de priorisation des comptes. Tous les clients sont traités pareil.", solution: "Agent service client dédié + comptes en tension remontés automatiquement dans le brief.", result: "Les comptes en tension arrivent priorisés dans le brief, signaux chiffrés à l'appui." },
        { team: "Finance", icon: teamIcon("M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2zM22 3h-6a4 4 0 0 1-4 4v14a3 3 0 0 0 3-3h7z"), pain: "Les impayés s'accumulent sans relance systématique. Le churn involontaire coûte du MRR.", solution: "Détection des factures en retard + rappel officiel de facturation exécuté après validation.", result: "Cash récupéré attribué en euros, relance par relance." },
      ]}
      relatedProducts={[
