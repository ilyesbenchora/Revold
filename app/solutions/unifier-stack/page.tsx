...
export default function UnifierStackPage() {
  return (
    <SolutionPage
      ...
      subtitle="68% des organisations citent les silos de données comme obstacle #1. Revold se pose au-dessus de vos outils existants — CRM, facturation, compta, support, phoning — et les fait parler entre eux."
      ...
      shot={<ShotDashboard />}
      keyBenefits={[
        { title: "Connecteurs natifs, câblés en profondeur", desc: "CRM en un clic, facturation et compta par clé API + import Excel / Google Sheets. Sans code, sans scripts custom, en lecture seule révocable." },
        { title: "Rapprochement par identifiants légaux", desc: "Identifiants légaux : la même entreprise est reconnue partout, et les identifiants manquants sont remplis via les registres officiels." },
      ...
      teams={[
        { team: "Direction", icon: teamIcon("M3 3v18h18"), pain: "Chaque équipe a ses outils, ses dashboards, ses chiffres. Pas d'alignement.", solution: "Une plateforme au-dessus de tous les outils avec une vue unifiée et des espaces par équipe.", result: "Un modèle de données commun — chaque équipe garde son espace, les chiffres restent les mêmes." },
        { team: "RevOps", icon: teamIcon("M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83"), pain: "Maintenance d'intégrations custom fragiles. Chaque changement d'outil casse tout.", solution: "Connecteurs natifs maintenus par Revold + audit d'onboarding par outil connecté.", result: "Les connecteurs sont maintenus par Revold — aucun script custom à réparer à chaque changement d'outil." },
        { team: "Finance", icon: teamIcon("M2 3h6a4 4 0 0 1 4 4v14a3 3 0 0 0-3-3H2zM22 3h-6a4 4 0 0 1-4 4v14a3 3 0 0 0 3-3h7z"), pain: "Les données financières (facturation, compta) ne sont pas connectées au CRM.", solution: "Factures, abonnements et écritures synchronisés et croisés avec le pipeline.", result: "Écarts signé / facturé / encaissé chiffrés entreprise par entreprise, à chaque sync." },
      ]}
      relatedProducts={[
