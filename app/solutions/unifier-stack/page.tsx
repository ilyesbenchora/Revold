  ...
  return (
    <SolutionPage
      ...
      teams={[
        ...
        { team: "Marketing", icon: teamIcon("M3 3v18h18M7 16l4-8 4 4 4-8"), pain: "Le CRM ne voit pas les données de facturation ni les encaissements.", solution: "Les données Stripe / Pennylane sont croisées avec le CRM dans les rapports marketing.", result: "Attribution end-to-end : campagne → lead → deal → facture → rétention." },
        { team: "Sales", icon: teamIcon("M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"), pain: "Le CRM ne montre pas les factures ni l'historique de paiement du client.", solution: "Fiche client enrichie : deal + factures + abonnements, rapprochés par SIREN / TVA.", result: "Contexte complet pour chaque conversation commerciale." },
        ...
        { team: "CSM", icon: teamIcon("M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78L12 21.23l8.84-8.84a5.5 5.5 0 0 0 0-7.78z"), pain: "Pas de vue unifiée du client entre CRM, facturation et abonnements.", solution: "Résolution d'entités cross-source : un client = une fiche, toutes les sources.", result: "Onboarding, suivi et renouvellement avec contexte complet." },
