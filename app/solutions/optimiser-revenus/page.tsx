  ...
  return (
    <SolutionPage
      ...
      teams={[
        ...
        { team: "CSM", icon: teamIcon("M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78L12 21.23l8.84-8.84a5.5 5.5 0 0 0 0-7.78z"), pain: "Pas de visibilité sur les signaux de churn avant qu'il ne soit trop tard.", solution: "Croisement tickets × paiements × activité CRM, coach dédié et alertes câblées.", result: "Intervention proactive sur les comptes à risque. Rétention défendue par la donnée." },
