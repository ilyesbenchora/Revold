...
export default function OptimiserRevenusPage() {
  return (
    <SolutionPage
      ...
      teams={[
        { team: "Direction", icon: teamIcon("M3 3v18h18"), pain: "Aucune visibilité fiable sur les revenus. Les chiffres changent selon qui les présente.", solution: "KPIs câblés et vérifiés, projection pondérée du pipeline, brief du jour à la voix.", result: "Un seul pipeline pondéré, recalculé à chaque sync — le même chiffre pour tout le monde." },
        { team: "Sales", icon: teamIcon("M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"), pain: "Deals qui meurent en silence, relances oubliées, pipeline gonflé.", solution: "Détection des deals silencieux → tâche CRM créée après validation + projection pondérée du pipeline.", result: "Les deals silencieux ressortent avec leur relance prête ; le pondéré suit les probabilités réelles." },
