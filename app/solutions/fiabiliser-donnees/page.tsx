...
export const metadata: Metadata = {
  ...
  description: "Audit automatique, déduplication automatique et enrichissement Sirene/INPI : une base CRM propre, complète et rapprochée de la facturation.",
};
...
export default function FiabiliserDonneesPage() {
  return (
    <SolutionPage
      ...
      subtitle="76% des orgas ont moins de 50% de données CRM fiables. Revold audite vos données, les rapproche par identifiants officiels et remplit les identifiants manquants depuis la base Sirene officielle."
      ...
      keyBenefits={[
        ...
        { title: "Rapprochement à la française", desc: "Identifiants légaux, email, domaine et ID custom : une vue unique par entreprise entre CRM, facturation et compta." },
        { title: "Enrichissement Sirene", desc: "Les identifiants manquants sont remplis depuis la base Sirene officielle, validés par vous en un clic — et écrits aussi dans votre CRM." },
      ]}
      teams={[
