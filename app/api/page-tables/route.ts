...
export const TABLE_COLS =
  "id, page_key, title, entity, group_by, measure, field, unit_mode, view, custom_kpi, description, period_preset, sources, show_total, show_filters, pipeline, granularity, cohort_key, cohort_value, position, created_at";
