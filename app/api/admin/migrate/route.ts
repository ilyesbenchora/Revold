/**
 * ENDPOINT TEMPORAIRE — à supprimer après application des migrations 8.2 + 8.5.
 *
 * Exécute du SQL DDL arbitraire contre la base Postgres Supabase via la lib `pg`.
 * Protégé par MIGRATION_SECRET (header `x-migration-secret`).
 *
 * À retirer du repo dès que les migrations sont appliquées et vérifiées.
 */
