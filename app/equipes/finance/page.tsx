    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-5xl px-6 pb-16 pt-16 text-center md:pb-24 md:pt-24">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg text-slate-400">MRR/ARR calculés en temps réel depuis votre outil de facturation, trésorerie en projection pondérée et réconciliation automatique par SIREN / TVA. Fini les tableurs et les écarts inexpliqués.</p>
