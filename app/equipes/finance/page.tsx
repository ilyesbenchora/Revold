...
export const metadata: Metadata = {
  ...
  description: "Revold réconcilie automatiquement pipeline CRM et revenus facturés par identifiants officiels. MRR/ARR temps réel, projection pondérée de trésorerie, échéances fiscales et relances d'impayés exécutées.",
};
