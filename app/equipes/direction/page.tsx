        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-12 space-y-6">
            {[
              ...
              { title: "Revenue réel vs prévu", desc: "Croisement pipeline CRM × factures, rapprochées par SIREN / SIRET / TVA. Vous voyez l'écart entre ce que le CRM promet et ce que la facturation confirme.", icon: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
