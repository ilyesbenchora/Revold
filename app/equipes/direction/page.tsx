        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-12 space-y-6">
            {[
              ...
              { title: "Revenue réel vs prévu", desc: "Croisement pipeline CRM × factures, rapprochées par identifiants officiels. Vous voyez l'écart entre ce que le CRM promet et ce que la facturation confirme.", icon: "M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
              ...
              { title: "Actions validées, exécutées dans vos outils", desc: "Deal silencieux → tâche CRM. Facture en retard → rappel officiel de facturation. Vous validez, l'action s'exécute — et chaque euro récupéré est attribué, ligne par ligne.", icon: "M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" },
            ].map((f) => (
