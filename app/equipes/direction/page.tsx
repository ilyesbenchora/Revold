        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-12 space-y-6">
            {[
              ...
              { title: "Équipe IA 24/7", desc: "Des agents experts par domaine et des coachs par métier analysent vos données cross-source et produisent des recommandations priorisées : où agir, pourquoi, quel impact attendu.", icon: "M13 10V3L4 14h7v7l9-11h-7z" },
