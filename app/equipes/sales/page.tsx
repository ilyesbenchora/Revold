...
export const metadata: Metadata = {
  ...
  description: "Revold aide les équipes commerciales à closer plus de deals : détection des deals silencieux, tâches CRM créées après validation, agent Sales IA 24/7 et projection pondérée du pipeline.",
};
      ...
      <section className="py-20">
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-12 space-y-6">
            {[
              { title: "Pipeline temps réel", desc: "Visualisez l'ensemble de votre pipeline avec les montants, probabilités et dates de close synchronisés automatiquement depuis votre CRM.", icon: "M9 17V7m0 10a2 2 0 01-2 2H5a2 2 0 01-2-2V7a2 2 0 012-2h2a2 2 0 012 2m0 10a2 2 0 002 2h2a2 2 0 002-2M9 7a2 2 0 012-2h2a2 2 0 012 2m0 10V7m0 10a2 2 0 002 2h2a2 2 0 002-2V7a2 2 0 00-2-2h-2a2 2 0 00-2 2" },
              { title: "Deals silencieux détectés, tâche créée", desc: "Deal sans activité depuis 21 jours ? Revold le détecte et vous propose l'action : vous validez, la tâche est créée directement dans le CRM pour le bon commercial.", icon: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" },
              ...
              { title: "Projection pondérée du pipeline", desc: "Montants × probabilités par stage, croisés avec la facturation réelle rapprochée par identifiants officiels. Fini la lecture du pipeline au doigt mouillé.", icon: "M3 3v18h18M7 16l4-8 4 4 4-8" },
