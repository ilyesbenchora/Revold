...
export const metadata: Metadata = {
  ...
  description: "Revold automatise les récaps cross-source, fiabilise les données par rapprochement automatique et enrichissement officiel. Arrêtez la plomberie data, pilotez la stratégie.",
};
