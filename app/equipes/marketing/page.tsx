        ...
        <div className="mx-auto max-w-4xl px-6">
          ...
          <div className="mt-12 space-y-6">
            {[
              ...
              { title: "Qualité des leads mesurée", desc: "Taux de conversion, doublons détectés, données manquantes remplies depuis les registres officiels. Améliorez la qualité avant de scaler le volume.", icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" },
