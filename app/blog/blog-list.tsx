...
import { CATEGORIES, type BlogArticle } from "./data";

/**
 * Liste du blog (filtre par catégorie côté client). Les articles reçus sont
 * déjà filtrés côté serveur (publication programmée, voir published.ts).
 */
      ...
      <section className="relative overflow-hidden border-b border-white/10 py-16 text-center md:py-24">
        ...
        <div className="relative mx-auto max-w-4xl px-6">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-400">
            RevOps, forecast, churn, réconciliation CRM × facturation : des guides chiffrés pour les équipes revenue B2B françaises. Deux articles par semaine.
          </p>
          <p className="mt-2 text-sm text-slate-500">Par Ilyes Benchora, Expert RevOps</p>
          <div className="mt-3 flex items-center justify-center gap-3 text-xs">
            <Link href="/blog/rss.xml" className="text-fuchsia-300 hover:underline">Flux RSS</Link>
            <span className="text-slate-600">·</span>
            <Link href="/glossaire-revops" className="text-fuchsia-300 hover:underline">Glossaire</Link>
            <span className="text-slate-600">·</span>
            <Link href="/outils" className="text-fuchsia-300 hover:underline">Calculateurs</Link>
          </div>
        </div>
      </section>
