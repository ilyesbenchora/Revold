...
// Définitions PARTAGÉES dans un module server-safe (lib/integrations/mapping-pages) :
// la page serveur Paramètres les importe pour précharger les mappings. Les
