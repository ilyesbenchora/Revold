...
const coachingChildren: LeafLink[] = [
  ...
  {
    // Sofia (Coach data & intégration) a repris data ET intégration : une
    // seule entrée — l'ancienne page Intégration n'a plus d'agent dédié.
  ...
  {
    // Aligné sur l'agent « Coach finance » (ex-Modèles de données).
